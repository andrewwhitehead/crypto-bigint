...
impl<const LIMBS: usize> Uint<LIMBS> {
    ...
    pub const fn jacobi_symbol<const RHS_LIMBS: usize>(
        ...
        crate::modular::gcd::jacobi_symbol(lhs.as_mut_uint_ref(), rhs.as_mut_uint_ref())
    }
    ...
    pub const fn jacobi_symbol_vartime<const RHS_LIMBS: usize>(
        ...
        let mut rhs = *rhs.as_ref();
        crate::modular::gcd::jacobi_symbol_vartime(lhs.as_mut_uint_ref(), rhs.as_mut_uint_ref())
    }
}
